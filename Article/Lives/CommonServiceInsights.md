---
title: 做通用服务的一些感悟
description: 总结通用服务开发的核心理念：简单易用、合理封装、追求极致体验，以及文档编写和服务意识的重要性
---

# 做通用服务的一些感悟 {#common-service-insights}

> 转载: https://neveryu.github.io/2022/thoughts-1/
>
> 作者: neveryu

![生成人像摄影图片.webp](/imgs/1764215714608.avif)

## 总结 {#summary}

入职滴滴一年, 造了不少公司级别的“轮子”, 不少轮子已经在业务线跑起来了, 运行状况还算可以. 我自己也总结了做通用服务要注意的几点:

### 1.一定要好用, 用起来要简单 {#easy-to-use}
...
我们在设计通用 JS 库的时候, 一定要站在**更高的角度去对需求做抽象**.
...
### 2.该做封装的地方要封装, 对外暴露的接口越少越好 {#encapsulation}
...
### 3.先思考再动手, 设计合理的代码组织方式 {#think-before-coding}
...
### 4.追求体验极致 {#pursue-perfect-experience}
