...
## 为何软件工程师格外脆弱 {#why-engineers-vulnerable}

![](/imgs/1778493577827.avif)

我们工作的若干特性，使我们比普通知识工作者更易暴露于这一风险之下。

### 表面信号默认看起来是正确的 {#surface-signals}
...
### 像AI没有写它一样审查差异比对 {#review-as-if-human}
...
### 以验证作为硬性完成标准 {#verification-standard}
...
## 相互放大，而非委托外包 {#mutual-amplification}
