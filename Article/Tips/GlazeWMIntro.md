---
title: Windows 平铺管理器 GlazeWM
description: GlazeWM 使用体验分享，让 Windows 也能拥有媲美 Linux 的平铺窗口管理
---

# Windows 平铺管理器 GlazeWM {#glazewm-intro}
...
## 为什么选择 GlazeWM? {#why-glazewm}

### 1. 稳定可靠 {#stable-reliable}
...
## 不再羡慕 Linux 用户 {#no-longer-envy-linux}
